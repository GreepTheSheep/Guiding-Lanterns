    ...
    try {
        ...
        if (timestamps.has(message.author.id)) {
            ...
            if (now < expirationTime) {
                ...
                return message.reply('I need to reload the toy! Please wait again ' + seconds.toFixed(0) + ' seconds if it\'s possible to you!').then(m=>{m.delete({timeout: 10000}) ; message.delete({ timeout: 10000 })})
            }
        }
