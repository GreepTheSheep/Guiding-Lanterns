...
function about(message, client, prefix) {
    ...
    if (os.platform == 'win32'){
        var osuptime = 'The operating system is on Windows, the result of this function no longer contains a fraction component on Windows.'
    } else {
        var osuptime = (Math.round(os.uptime / (1000 * 60 * 60 * 24))) + " days, " + (Math.round(os.uptime / (1000 * 60 * 60)) % 24) + " hours, " + (Math.round(os.uptime / (1000 * 60)) % 60) + " minutes, and " + (Math.round(os.uptime / 1000) % 60) + " seconds";
    }
