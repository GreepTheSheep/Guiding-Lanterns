...
module.exports = function(message, client, prefix, getlogchannel, cooldowns) {
    ...
    if (message.guild.id == '562602234265731080') {
        ...
        // change the topic
        client.channels.cache.find(c=> c.id == '717018224784310342').setTopic(`<:Lanterne:717500316987162655> | Vous avez lancé ${counter.get(message.guild.id)} lanternes depuis le début du mini-jeu!\n\n/r/Tangled à lancé ${counter.get('count')} lanternes!`)
    }
