...
function status(message, client, prefix) {
    ...
    if (message.content.startsWith(prefix + 'setgame')) {
        ...
        message.channel.send(`The status of the bot has been set to "Playing **${args.join(" ")}**" !`)
    }
    if (message.content.startsWith(prefix + 'setwatch')) {
        ...
        message.channel.send(`The status of the bot has been set to "Watching **${args.join(" ")}**" !`)
    }
    if (message.content.startsWith(prefix + 'setlisten')) {
        ...
        message.channel.send(`The status of the bot has been set to "Listening to **${args.join(" ")}**" !`)
    }
}
