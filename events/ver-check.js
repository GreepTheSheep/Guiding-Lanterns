...
function versionCheck(client) {
    ...
    if (!verCheck) fs.writeFile(verCheckfile, package.version.slice(0, package.version.indexOf('.', package.version.indexOf('.'))), function(){
    ...
    if (package.version != verCheck) {
        fs.writeFileSync(verCheckfile, package.version.slice(0, package.version.indexOf('.', package.version.indexOf('.'))))
        if (package.version.slice(0, package.version.indexOf('.', package.version.indexOf('.'))) =! verCheck) {
